        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div>
                ...
                <?php
                    include('connection.php');
                    $x=$_SESSION['email'];
                $query = "select * from course_list where c_id not in (select c_id from fcty_course where fcty_email= '$x');";  
                $result = mysqli_query($conn, $query); 
                $count=0; 
                      ...
                      <div class="card" style="width:300px">
                                 <div class="card-body">
                                        ...
                                        <p class="card-text">'.$row['c_about'].'</p>
                                         ...
                                         <form action="fcty_course.php" method="GET" >
                                           <button type="submit" name="submit" class="btn btn-primary" value="'.$row['c_id'].'">Register Now</button>
                                         </form>
